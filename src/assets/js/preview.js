		...
		$(this).each(function(){
			$(this).hover(function(e){
				if(/.png$|.gif$|.jpg$|.bmp$|.jpeg$/.test($(this).attr("data-bimg"))){
					var addStr= $(this).parent().parent().parent().find(".itemDetailClass").html();
					if(!addStr){
						addStr="";
					}
					$("body").append("<div id='preview'><img src='"+$(this).attr('data-bimg')+"' /><p style='max-width: 450px;'>"+addStr+"</p></div>");
				}
